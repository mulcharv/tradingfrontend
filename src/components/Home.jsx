...
function Home(props) {
    ...
    async function fetchDetails() {
        ...
        const prtfurl = `https://mongodb-production-3bca.up.railway.app/portfolio/${userId}`;
        ...
        if (wldata.status === 404) {
            ...
            for (const ticker of tickers) {
                let url = `https://mongodb-production-3bca.up.railway.app/stocks/${ticker}/latestdata`;
