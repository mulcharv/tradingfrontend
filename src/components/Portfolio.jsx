...
function Portfolio(props) {
    ...
    async function fetchPortfolio() {
        ...
        if (userId.length > 0) {
            const ptfurl = `https://tradingapideploy-2cfabb06dbc1.herokuapp.com/portfolio/${userId}`;
            ...
            if (ptfdata.status === 404) {
                ...
                for (const position of ptfdata.positions) {
                    ...
                    let stockurl = `https://tradingapideploy-2cfabb06dbc1.herokuapp.com/stocks/${position.ticker}/latestdata`;     
